                        ...
                        <table class="table table-striped table-condensed">
                            ...
                            <tbody>
                                ...
                                @foreach ($direct_reports as $direct_report)
                                    ...
                                    <tr @if ($direct_report->unviewedIncidents()->count() == 0) class="text-success" @endif>
                            ...
                            <table class="table table-striped table-condensed">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($division->users as $user)
                                        ...
                                        @php
                                            $unviewedCount = $user->unviewedIncidents()->count();
                                        @endphp

                                        <tr @if ( !$unviewedCount) class="text-success" @endif >
